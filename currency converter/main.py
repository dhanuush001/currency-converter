...
class CurrencyFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        font_emoji = wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL,
                             faceName="Segoe UI Emoji")
        ...
        self.txt_result = wx.TextCtrl(card_panel, value="---", size=(120, 45),
    ...
    def on_show_graph(self, event):
        ...
        if time_frame == "1 Week":
            days_to_fetch, step = 7, 1
        elif time_frame == "1 Month":
            days_to_fetch, step = 30, 2
        elif time_frame == "1 Year":
            days_to_fetch, step = 365, 7
        elif time_frame == "5 Years":
            days_to_fetch, step = 365 * 5, 30
        elif time_frame == "10 Years":
            days_to_fetch, step = 365 * 10, 60
        ...
        try:
            ...
            for i in range(days_to_fetch, -1, -step):
                ...
                if from_code == "USD":
                    ...
                    r1 = self.c.get_rate("USD", from_code, d)

                if to_code == "USD":
                    r2 = 1.0
                else:
                    r2 = self.c.get_rate("USD", to_code, d)
